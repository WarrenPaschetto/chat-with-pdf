...
function PricingPage() {
    ...
    // Pull in user's subscription with custom hook
  ...
  <div>
    <div className="py-24 sm:py-32">
      ...
      text-gray-600">
        Choose an affordable plan that is packed with the best features for interacting with your PDFs, enhancing productivity, and streamlining your workflow.
      </p>

      <div className="max-w-md mx-auto mt-10 grid grid-cols-1 md:grid-cols-2
      md:max-w-2xl gap-8 lg:max-w-4xl">
        {/*Free Plan*/}
        ...
        <div className="ring-2 ring-indigo-600 rounded-3xl p-8">
            ...
            hover:bg-indigo-500 mt-6 block rounded-md px-3 py-2 text-center text-sm
