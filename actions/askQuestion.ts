...
export async function askQuestion(id: string, question: string) {
    ...
    // check if user is on the FREE plan and has asked more than the FREE number of questions
    ...
    // check if user is on the PRO plan and has asked more than 100 questions
    if (!userRef.data()?.hasActiveMembership) {
